...
<head>
    ...
    <style>
        /* تنسيقات متوافقة 100% مع معايير مكتبة mpdf للطباعة */
        body {
            font-family: sans-serif; /* مكتبة mpdf ستقوم بتبديله تلقائياً لخط عربي ممتاز */
            direction: rtl;
            text-align: right;
            color: #2d3748;
            line-height: 1.6;
...
<table class="cost-table">
    ...
    <tr class="total-row">
        <td colspan="2" style="text-align: left; padding-left: 15px;">إجمالي التكلفة الكلية المعتمدة للمشروع:</td>
        <td>{{ number_format($form->total_cost, 2) }} د.أ</td>
    </tr>
    </tbody>
</table>

<div class="section-title">4. الملاحظات والاعتمادات الرسمية للأطراف</div>

<p style="margin-bottom: 2px; font-weight: bold; color: #2b6cb0;">ملاحظات واعتماد المهندس المدقق:</p>
<div class="notes-box">
    {{ $form->engineer_notes ?? 'تمت المراجعة والقبول الفني والإنشائي من قِبل المهندس المختص دون أي ملاحظات.' }}
</div>

<p style="margin-bottom: 2px; font-weight: bold; color: #2b6cb0;">ملاحظات واعتماد المتضرر (المستفيد النهائي):</p>
<div class="notes-box">
