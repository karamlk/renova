...
import 'package:renove_provider/screens/User/wallet/user_wallet_index_screen.dart';
                  ...
                  children: [
                    ...
                    ElevatedButton(
                      ...
                      onPressed: () {
                        Navigator.of(
                          context,
                        ).push(MaterialPageRoute(builder: (context) => InvoicesIndex()));
                      },
                      child: Column(
                        spacing: 20,
                        mainAxisAlignment: MainAxisAlignment.center,
                        children: [
                          CircleAvatar(
                            backgroundColor: Colors.white24,
                            radius: 35,
                            child: Icon(Icons.payment, size: 35, color: primarycolor1),
                          ),
                          Text(
                            'الفواتير',
                            style: TextStyle(fontWeight: FontWeight.bold, fontSize: 16),
                    ...
                    ElevatedButton(
                      ...
                      onPressed: () {
                        Navigator.of(
                          context,
                        ).push(MaterialPageRoute(builder: (context) => PaymentsIndex()));
                      },
                      child: Column(
                        spacing: 20,
                        mainAxisAlignment: MainAxisAlignment.center,
                    ...
                    ElevatedButton(
                      ...
                      onPressed: () {
                        Navigator.of(
                          context,
                        ).push(MaterialPageRoute(builder: (context) => UserWalletIndexScreen()));
                      },
                      child: Column(
                        spacing: 20,
                        mainAxisAlignment: MainAxisAlignment.center,
