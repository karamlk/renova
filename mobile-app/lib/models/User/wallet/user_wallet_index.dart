class UserWalletIndex {
  final String balance;
  final String cardNumber;
  final List<TransactionModel> transactions;

  UserWalletIndex({required this.balance, required this.cardNumber, required this.transactions});

  factory UserWalletIndex.fromJson(Map<String, dynamic> json) {
    return UserWalletIndex(
